...
style=pygame.mixer.Sound('image/musique et effet/force.mp3')
style.play(loops=-1)
...
for i in range(1,299):
    frame1 = pygame.image.load(f"image/animation1/{i}.png").convert_alpha()
...
image1 = pygame.image.load("image/Robot (1).png").convert_alpha()
start = pygame.image.load("image/start_btn.png").convert_alpha()
background10 = pygame.image.load("image/Ete fi.png").convert_alpha()
...
pygame.mixer.init()
effect=pygame.mixer.Sound('image/musique et effet/click-sound.mp3')


musique2=pygame.mixer.Sound('image/musique et effet/aw2.mp3')
musique=pygame.mixer.Sound('image/musique et effet/aw.mp3')
musique3=pygame.mixer.Sound('image/musique et effet/aw3.mp3')
musique4=pygame.mixer.Sound('image/musique et effet/aw4.mp3')
...
animation_frames = []
for i in range(1,30):
    frame = pygame.image.load(f"image/animation/{i}.png").convert_alpha()
...
background = pygame.image.load("image/Ete fi.png").convert_alpha()
background2= pygame.image.load("image/Hiver. fi.png").convert_alpha()
background3=pygame.image.load("image/PRI fi.png").convert_alpha()
image  = pygame.image.load("image/Rea.png").convert_alpha()
image_size = pygame.Rect((324,150),(185,200))
rea = pygame.image.load("image/Rea_petit.png").convert_alpha()
rea_bouton=button.Button(15, 70, rea, 1)

achtung_img= pygame.image.load("image/achtung.png").convert_alpha()
achtung2_img= pygame.image.load("image/achtung2.png").convert_alpha()
...
gravas = pygame.image.load("image/Logo_gravas.png").convert_alpha()


mis_rempli= pygame.image.load("image/mis rempli.png").convert_alpha()
mis_rempli_bouton=button.Button(15, 170, mis_rempli, 1)
rempli= pygame.image.load("image/rempli.png").convert_alpha()
rempli_bouton=button.Button(15, 170, rempli, 1)
non_rempli= pygame.image.load("image/non rempli.png").convert_alpha()
non_rempli_bouton=button.Button(15, 170, non_rempli, 1)

robot_img= pygame.image.load("image/robot.png").convert_alpha()
robot_bouton = button.Button(100,50, robot_img, 1)

background1 = pygame.image.load("image/Autfi.png").convert_alpha()


dollar_img = pygame.image.load("image/$.png").convert_alpha()
dollar_bouton = button.Button(5,230, dollar_img, 1)


dix_img = pygame.image.load('image/100.png').convert_alpha()
dix_bouton = button.Button(110, 250, dix_img, 1)

neuf_img = pygame.image.load('image/90.png').convert_alpha()
neuf_bouton = button.Button(170, 250, neuf_img, 1)

huit_img = pygame.image.load('image/80.png').convert_alpha()
huit_bouton = button.Button(230, 250, huit_img, 1)

sept_img = pygame.image.load('image/70.png').convert_alpha()
sept_bouton = button.Button(290, 250, sept_img, 1)

six_img = pygame.image.load('image/60.png').convert_alpha()
six_bouton = button.Button(350, 250, six_img, 1)

cinq_img = pygame.image.load('image/50.png').convert_alpha()
cinq_bouton = button.Button(460, 250, cinq_img, 1)

quatre_img = pygame.image.load('image/40.png').convert_alpha()
quatre_bouton = button.Button(570, 250, quatre_img, 1)

trois_img = pygame.image.load('image/30.png').convert_alpha()
trois_bouton = button.Button(630, 250, trois_img, 1)

deux_img = pygame.image.load('image/20.png').convert_alpha()
deux_bouton = button.Button(690, 250, deux_img, 1)

un_img = pygame.image.load('image/10.png').convert_alpha()
un_bouton = button.Button(750, 250, un_img, 1)

zero_img = pygame.image.load('image/0.png').convert_alpha()
zero_bouton = button.Button(810, 250, zero_img, 1)

curseur_img=pygame.image.load('image/curseur.png').convert_alpha()
curseur_bouton=button.Button(5, 70, curseur_img, 1)

curseur2_img=pygame.image.load('image/curseur2.png').convert_alpha()
curseur2_bouton=button.Button(5, 150, curseur2_img, 1)

#boutique_img = pygame.image.load('image/BOUTIQUE.png').convert_alpha()
#boutique_bouton = button.Button(5, 70, boutique_img, 1)

cailloux_img=pygame.image.load('image/CAILLOUX.png').convert_alpha()
cailloux_bouton = button.Button(5, 70, cailloux_img, 1)

citrine_img=pygame.image.load('image/citrine1_petit.png').convert_alpha()
citrine_bouton= button.Button(5, 70, citrine_img, 1)
citrine_img=pygame.image.load('image/citrine1.png').convert_alpha()

oeil_img=pygame.image.load('image/Oeil du tigre_petit.png').convert_alpha()
oeil_bouton= button.Button(5, 300, oeil_img, 1)
oeil_img=pygame.image.load('image/Oeil du tigre.png').convert_alpha()

kirby_gif=pygame.image.load('image/kirby.gif').convert_alpha()
kirby_bouton= button.Button(300, 12, kirby_gif, 1)

mode_histoire_img= pygame.image.load('image/MODE HISTOIRE.png').convert_alpha()
mode_histoire_bouton= button.Button(5, 150, mode_histoire_img, 1)

danger_img= pygame.image.load('image/Danger.png').convert_alpha()
danger_bouton= button.Button(5,230, danger_img, 1)

jaspe_img=pygame.image.load("image/Jaspe_rougeV2.png").convert_alpha()
jaspe_bouton=button.Button(5, 150, jaspe_img, 1)
jaspe_img=pygame.image.load("image/Jaspe_rougeV2_grand.png").convert_alpha()

Labradorite_img = pygame.image.load('image/Labradorite.png').convert_alpha()
Labradorite_bouton = button.Button(5, 230, Labradorite_img, 1)
Labradorite_img = pygame.image.load('image/Labradorite_grand.png').convert_alpha()

Sodalite_img = pygame.image.load('image/Sodalite_petit.png').convert_alpha()
Sodalite_bouton = button.Button(5, 300, Sodalite_img, 1)
Sodalite_img = pygame.image.load('image/Sodalite.png').convert_alpha()

Aigue_Marine_petit_img = pygame.image.load('image/Aigue Marine_petit.png').convert_alpha()
Aigue_Marine_bouton = button.Button(5, 300, Aigue_Marine_petit_img, 1)
Aigue_Marine_img = pygame.image.load('image/Aigue Marine.png').convert_alpha()

pierre_du_soleil_petit_img = pygame.image.load('image/Pierre du Soleil_petit.png').convert_alpha()
pierre_du_soleil_bouton = button.Button(5, 150, pierre_du_soleil_petit_img, 1)
pierre_du_soleil_img = pygame.image.load('image/Pierre du Soleil.png').convert_alpha()

nacre_img=pygame.image.load("image/Nacre_petit.png").convert_alpha()
nacre_bouton=button.Button(5, 230, nacre_img, 1)
nacre_img=pygame.image.load("image/Nacre.png").convert_alpha()

hematite_img=pygame.image.load("image/Hematite_petit.png").convert_alpha()
hematite_bouton=button.Button(5, 70, hematite_img, 1)
hematite_img=pygame.image.load("image/Hematite.png").convert_alpha()

pyrite_img=pygame.image.load("image/Pyrite_petit.png").convert_alpha()
pyrite_bouton=button.Button(5, 150, pyrite_img, 1)
pyrite_img=pygame.image.load("image/Pyrite.png").convert_alpha()

quartz_fumee_img=pygame.image.load("image/Quartz fumee_petit.png").convert_alpha()
quartz_fumee_bouton=button.Button(5, 230, quartz_fumee_img, 1)
quartz_fumee_img=pygame.image.load("image/Quartz fumee.png").convert_alpha()

amethyst_img=pygame.image.load('image/Amethyst_petit.png').convert_alpha()
amethyst_bouton= button.Button(5, 70, amethyst_img, 1)
amethyst_img=pygame.image.load('image/Amethyst.png').convert_alpha()

grenat_img = pygame.image.load('image/grenat_petit.png').convert_alpha()
grenat_bouton = button.Button(5, 150, grenat_img, 1)
grenat_img = pygame.image.load('image/grenat.png').convert_alpha()

quartz_img=pygame.image.load("image/Quartz rose_petit.png").convert_alpha()
quartz_bouton=button.Button(5, 230, quartz_img, 1)
quartz_img=pygame.image.load("image/Quartz rose.png").convert_alpha()

Rodocrosite_img = pygame.image.load('image/Rodocrosite_petit.png').convert_alpha()
Rodocrosite_bouton = button.Button(5, 320, Rodocrosite_img, 1)
Rodocrosite_img = pygame.image.load('image/Rodocrosite.png').convert_alpha()
